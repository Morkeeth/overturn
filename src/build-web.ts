...
const tpl = readFileSync('web/story.template.html', 'utf8');
...
writeFileSync('web/story.html', out);
console.log(`web/story.html written (${(out.length/1024).toFixed(0)} KB, self-contained)`);
